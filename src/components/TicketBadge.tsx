...
import { Calendar, MapPin, Sparkles, CheckCircle2, Download, Printer } from 'lucide-react';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: '#9CA3AF', fontSize: '0.9rem' }}>
          Your digital delegate pass has been issued. Please save or screenshot this badge for entry.
        </p>
      </div>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 25px 50px rgba(0, 0, 0, 0.8), 0 0 30px rgba(235, 0, 40, 0.2)',
          overflow: 'hidden',
          position: 'relative',
        }}
      >
        ...
        >
          ...
          <span style={{ fontSize: '0.72rem', fontWeight: 700, background: 'rgba(0,0,0,0.35)', padding: '0.2rem 0.55rem', borderRadius: '9999px', color: '#FFFFFF' }}>
            {tierName}
          </span>
        </div>
        ...
        <div style={{ padding: '1.75rem' }}>
          {/* TEDx Topfaith University branding */}
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
            <div className="ted-logo-wrap">
              <div className="ted-logo-main" style={{ fontSize: '1.35rem' }}>
                <span className="ted-red">TED</span>
                <span className="ted-x">x</span>
                <span className="ted-event-name" style={{ fontSize: '1.15rem' }}>TopfaithUniversity</span>
              </div>
              <span className="ted-tagline" style={{ fontSize: '0.52rem' }}>x = independently organized TED event</span>
            </div>
            <div
              style={{
                width: '32px',
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.07)', borderRadius: '12px', padding: '1rem', marginBottom: '1.25rem' }}>
            <div style={{ fontSize: '0.7rem', color: '#71717A', textTransform: 'uppercase', fontWeight: 600 }}>
              Attendee Name
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '1.5rem', fontSize: '0.82rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#D1D5DB' }}>
              <Calendar size={14} color="#EB0028" />
              <span>{EVENT_DETAILS.date}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#D1D5DB' }}>
              <MapPin size={14} color="#EB0028" />
              <span>Law Auditorium</span>
            </div>
          </div>
